 ...
 * JEE with Servlet
 * 
 * web server responds with HttpResponse
 */


// Servlet  is a java programming language class
// used to extends the capabilities of servers
// that host applicants accessed by means of
// a request-response programming model.

//1. extends javax.servlet.http.HttpServlet
//2. @webServlet(urlPatterns ="/VendorLoginServlet")
//3. doPost (HttpServletRequest request, HttpServletResponse response)
//4. how is response created?
...
//		response.setIntHeader("Refresh", 1);
		...
		String n = request.getParameter("vendorid");
...
//					request.getRequestDispatcher("index.html").forward(request, response);
			...
			if (submitType.equals("Edit Services")) {
				...
				if (MyDbImpl.vendorservice(vendorid, phone, avltimefrom, avltimeto, loc, servicetype1,categories) >0) {
...
//				request.getRequestDispatcher("Vendorupdatingdetails").forward(request, response);
				out.println(
						"<html><body><b>Successfully Inserted into service table" + "</b></body></html>");
		...
		String categories = request.getParameter("category1");
